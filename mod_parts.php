...
<script type = "text/javascript">
	history.pushState(null, null, 'mod_parts.php');
		...
		if($_SESSION['GID'] < 3000) {
			...
			**/
			...
			$query = "SELECT * from partsMasterFile
						 WHERE partsId = '$partsId' ORDER BY id DESC";
			$result = mysql_query($query);
			...
			if(isset($_POST['serialNumber']) && isset($_POST['partsNumber'])) {
				...
				**/
				...
				$query = "UPDATE partsMasterFile
							 SET
							 	partsNumber = '$partsNumber', partsDescription = '$partsDescription', partsUom = '$partsUom',
							 	partsBrand = '$partsBrand', partsModel = '$partsModel', partsWhereUsedI = '$partsWhereUsedI',
							 	partsWhereUsedII = '$partsWhereUsedII'
