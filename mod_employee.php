			...
			if($_SESSION['GID'] < 3000) {
				...
				**/
				if(isset($_POST['empName'])) {
					...
					$empName = ucwords(strtolower(mysql_escape_string($_POST['empName'])));
					$empSex = $_POST['empSex'];
					...
					$query = "UPDATE
								...
								SET
									...
									empNationality = '$empNationality', empCounty = '$empCounty',
									empDateJoin = '$empDateJoin', empStatus = '$empStatus', empCategory = '$empCategory',
									empCompanyCode = '$empCompanyCode', empDepartment = '$empDepartment',
									empUnit = '$empUnit', empPosition = '$empPosition', empBasicSalary = '$empBasicSalary',
